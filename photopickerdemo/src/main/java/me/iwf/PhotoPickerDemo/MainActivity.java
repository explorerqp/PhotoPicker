...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.init(this, MultiPickResultView.ACTION_SELECT, null, maxCount);

        recyclerViewShowOnly = (MultiPickResultView) findViewById(R.id.recycler_onlylook);
        recyclerViewShowOnly.init(this, MultiPickResultView.ACTION_ONLY_SHOW, pathslook, maxCount);
    ...
    private void onClick(@IdRes int viewId) {
       ...
       /* PhotoPicker.builder()
            ...
            .start(this);*/
                PhotoPickUtils.startPick(this, null, 8);
                break;
            }
